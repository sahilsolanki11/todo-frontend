        ...
        stage('Build UAT Docker Image') {
            steps {
                script {
                    ...
                    # Use backend container name, not localhost, for Docker networking
                    echo "REACT_APP_API_URL=http://todo-backend:5001/api" >> .env
        ...
        stage('Build Production Docker Image') {
            steps {
                script {
                    ...
                    echo "REACT_APP_API_URL=http://todo-backend:5000/api" >> .env
